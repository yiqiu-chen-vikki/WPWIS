...
@section('content')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('invoice.pending.list') }}" class="btn  btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-list"> Pending Invoice List </i></a> <br>  <br>               
...
<tr>
   ...
   <td class="text-center" style="background-color: #CBD6E2">{{ $details['product']['quantity'] }}</td>
